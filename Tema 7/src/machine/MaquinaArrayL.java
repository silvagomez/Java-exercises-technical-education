...
public class MaquinaArrayL extends JFrame implements ActionListener, ChangeListener{
	...
	private String[] bebidas={"Agua","Chocolate","Café","Kalimtxo","Whiskey"};
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(e.getSource()==b1) {
			...
			//PRUEBA DE ECTRACCION DE INFORMACIÓN - HAY QUE PROVARLO SIN TRY Y CATCH
