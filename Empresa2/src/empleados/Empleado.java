...
public abstract class Empleado {
	...
	protected Empleado(String n, String a, int t, byte e, boolean c, float s) {
	...
	protected void visualizarDatosEmpleado() {
	...
	protected void aumentarSalario(float incremento) {
